        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mb-6">
          <div className="text-center mb-8">
            ...
            <p className="text-base text-gray-500">
              Your reservation request has been received and saved. We'll confirm your table shortly via WhatsApp.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li className="flex items-start gap-2">
                ...
                <span>Check your WhatsApp messages for confirmation from our team</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">✓</span>
                <span>We'll send you a confirmation message within a few minutes</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">✓</span>
                <span>If you don't receive a message, please contact us using the details below</span>
              </li>
            </ul>
          </div>
