  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main>
        ...
        <section id="about" className="py-24 px-6 bg-primary scroll-mt-24">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -right-6 w-full h-full border-2 border-secondary rounded-3xl z-0"></div>
            </div>
            <div className="scroll-reveal opacity-0 translate-y-10 transition-all duration-1000 ease-out">
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed italic border-l-2 border-secondary pl-6">
                "Our mission is to serve as the definitive spectrum of modern dining—a place where every flavor tells a story of tradition and innovation."
              </p>
